...
public class JdbcBatchIdManager implements BatchIdManager {
  ...
  public static List<String> offsets = new ArrayList<>();
  public static final String ERR_CONF_BOTH_TS_AND_LONG_OFFSET_NOT_NULL =
          "createFirstRow: Contract-Violation: Both timestamp and "
          + "long offset are not null!";
  ...
  private void createFirstRow(Timestamp lastOffsetTs, Long lastOffsetLong) {
    if (lastOffsetTs != null && lastOffsetLong != null) {
      throw new ConnectException(ERR_CONF_BOTH_TS_AND_LONG_OFFSET_NOT_NULL);
    }
    try {
      if (lastOffsetTs == null && lastOffsetLong == null) {
        ...
        if (startOffsetTs == null) {
          ...
          if (DEBUG) {
            JdbcBatchIdManager.offsets.add(startOffsetTs + "");
          }
        }
        if (startOffsetLong == null) {
          ...
          if (DEBUG) {
            JdbcBatchIdManager.offsets.add(startOffsetLong + "");
          }
        }
